...
export function ThreadsIcon(props: IconProps) {
  // Drawn as strokes rather than the packaged filled path, whose inner counter
  // rendered as a solid blob at larger sizes.
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
      ...
      {...props}
    >
      <path d="M17.1 7.6C16.1 5.2 14.3 4 12 4 7.9 4 5.4 7 5.4 12s2.5 8 6.6 8c3.1 0 5.1-1.6 5.1-3.8 0-1.9-1.5-3.2-3.8-3.5" />
      <path d="M15.3 12.7c-1.9-.2-3.3.5-3.3 1.8 0 1 .9 1.7 2.1 1.7 2 0 3.2-1.6 3.2-4.1 0-2.5-1.3-4-3.4-4-1.1 0-2 .3-2.6 1" />
    </svg>
  );
}
